							...
							<div class="col-md-6 col-xl-6 col-sm-12">
								<div class="col-md-12 col-xl-12 col-sm-12 tele-home-div">
									<div class="row d-flex align-items-center">
										<div class="col-md-12 col-xl-7 col-sm-12 col-12">
											<h3>Urgent Care</h3>
											<p>With Nao Medical urgent care, we provide you with a wide range of services to help you with medical emergencies or everyday health care needs. Were open seven days a week to help when you need it most— in person or 24/7 virtually.</p>
										</div>
										<div class="col-md-12 col-xl-5 col-sm-12  col-12">
											<div class="">
												<a href="javascript:void(0)" class="btn btn-telhme appointment_modal">Make an Appointment</a>
								...
								<div class="col-md-12 col-xl-12 col-sm-12 tele-home-div">
									<div class="row d-flex align-items-center">
										<div class="col-md-12 col-xl-7 col-sm-12  col-12">
											...
											<p>Nao Medical offers the best reproductive medical providers to help you maintain and meet your health care goals. We’re available outside of regular doctor’s hours so you can get the care you need seven days a week, including holidays.</p>
										</div>
										<div class="col-md-12 col-xl-5 col-sm-12  col-12">
											<div class="">
												<a href="javascript:void(0)" class="btn btn-telhme appointment_modal">Make an Appointment</a>
						...
						<div class="col-md-12 col-sm-12 col-12">
							<div class="onsite-form-div">
                                <div class="onsite-form-max">
                                    ...
                                    <?php echo do_shortcode('[contact-form-7 id="6297" title="On-Site (Bulk) Testing Inquiries"]'); ?>
						...
						<div class="col-md-12 col-sm-12 col-12">
							<div class="onsite-form-div">
                                <div class="onsite-form-max">
                                    ...
                                    <?php echo do_shortcode('[contact-form-7 id="8430" title="Corporate Health Inquiries"]'); ?>
                                </div>
                            </div>
						</div>
					</div>
